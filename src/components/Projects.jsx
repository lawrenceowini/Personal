        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          {projects.map((project, index) => (
            <div key={project.github || index}>
              <div className="bg-gray-900 rounded-xl border border-gray-800 overflow-hidden hover:border-blue-600 hover:-translate-y-1 sm:hover:-translate-y-2 hover:shadow-[0_0_30px_rgba(37,99,235,0.7)] transition-all duration-300">
